export const LABELS = {
  es: {
    ...
    errorAlreadyInThisGroup: 'Ya estás en este grupo.',
    personalView:          'Personal',
    personalSub:           'Solo tus datos privados',
    yourGroups:            'Tus grupos',
    activeLabel:           'Activo',
    switchGroupA11y:       'Cambiar de grupo',
    useThisGroup:          'Usar este grupo',
    orLabel:               'O',
  ...
  en: {
    ...
    errorAlreadyInThisGroup: "You're already in this group.",
    personalView:          'Personal',
    personalSub:           'Only your private data',
    yourGroups:            'Your groups',
    activeLabel:           'Active',
    switchGroupA11y:       'Switch group',
    useThisGroup:          'Use this group',
    orLabel:               'OR',
